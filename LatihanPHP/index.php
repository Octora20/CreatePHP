...
$model = isset($_GET['modul']) ? $_GET['modul'] : "dashboard";
        ...
        switch($fitur) {
            case 'add':
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    $name = htmlspecialchars($_POST['role_name']);
                    $desc = htmlspecialchars($_POST['role_description']);
                    $status = intval($_POST['role_status']);
