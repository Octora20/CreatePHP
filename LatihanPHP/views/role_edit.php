    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="index.php?modul=role&fitur=edit&id=<?php echo isset($role->role_id) ? $role->role_id : ''; ?>" method="POST">
                    <!-- Nama Role -->
                    <div class="mb-4">
                        ...
                        value="<?php echo isset($role->role_name) ? htmlspecialchars($role->role_name) : ''; ?>">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        ><?php echo isset($role->role_description) ? htmlspecialchars($role->role_description) : ''; ?></textarea>
                    </div>
