    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="/LatihanPHP/index.php?modul=role&fitur=edit&id <?php echo $role->role_id; ?>" method="POST">
                    <!-- Nama Role -->
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="role_desc" name="role_desc" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan Deskripsi Role" rows="3" required>
                            <?php echo htmlspecialchars($role->role_desc); ?>
                        </textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="role_status" name="role_status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            ...
                            <option value="1" <?php echo ($role->role_status == 1) ? 'selected' : ''; ?>>Active
                            </option>
                            <option value="0" <?php echo ($role->role_status == 0) ? 'selected' : ''; ?>>Inactive
                        </option>
                        </select>
                    </div>
