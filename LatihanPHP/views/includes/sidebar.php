    <div class="w-[200px] shadow-2xl bg-white text-gray-500 h-screen">
        <div class="p-4 font-bold text-lg">Menu</div>
        <ul class="mt-4 space-y-2">
            <!-- Dashboard -->
            <li class="group">
                <div class="px-4 py-2 hover:text-orange-500 cursor-pointer group-hover:text-orange-500 text-sm">
                    <a href="index.php?modul=dashboard">Home</a>
    ...
    <!--            </ul>-->
            ...
            <li class="group">
                <div class="px-4 py-2 hover:text-orange-500 cursor-pointer group-hover:text-orange-500 text-sm">
                    <a href="index.php?modul=item">Master Data Barang</a>
                </div>
    <!--            <ul class="ml-4 space-y-1 hidden group-hover:block">-->
    <!--                <li class="px-4 py-2 hover:bg-gray-700 cursor-pointer">List</li>-->
    <!--                <li class="px-4 py-2 hover:bg-gray-700 cursor-pointer">Insert</li>-->
    ...
    <!--            </ul>-->
            ...
            <li class="group">
            <div class="px-4 py-2 hover:text-orange-500 cursor-pointer group-hover:text-orange-500 text-sm">Menu Transaksi</div>
                <ul class="ml-4 space-y-1 hidden group-hover:block">
                    <li class="px-4 py-2 hover:text-orange-500 cursor-pointer text-sm">
